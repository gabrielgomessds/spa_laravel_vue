            ...
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-6">
                    <label for="name" class="block mb-2 text-sm font-medium"
                        :class="{ 'text-gray-900': !form.errors.name, 'text-red-700': form.errors.name }">Nome</label>
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="category_id" class="block mb-2 text-sm font-medium"
                        :class="{ 'text-gray-900': !form.errors.category_id, 'text-red-700': form.errors.category_id }">Categorias</label>
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="price" class="block mb-2 text-sm font-medium"
                        :class="{ 'text-gray-900': !form.errors.price, 'text-red-700': form.errors.price }">Preço</label>
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="stocks" class="block mb-2 text-sm font-medium"
                        :class="{ 'text-gray-900': !form.errors.weight, 'text-red-700': form.errors.weight }">Peso</label>
                ...
                <div class="col-span-6 sm:col-span-6">
                    <label for="description" class="block mb-2 text-sm font-medium"
                        :class="{ 'text-gray-900': !form.errors.description, 'text-red-700': form.errors.description }">Descrição</label>
                    ...
                    <div class="font-sm text-red-500 mt-2" v-if="form.errors.description">{{ form.errors.description }}
                    </div>
                </div>
