    ...
    <Modal :show="show" max-width="xl" @close="emit('close')">
        <form class="relative bg-white rounded-lg shadow" @submit.prevent="update">
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-6">
                        <label class="block mb-2 text-sm font-medium text-gray-900 ">Produtos</label>
                        <ul>
                            <li class="flex items-center" v-for="product in products" :key="product.id">
                        ...
                        <div class="font-sm text-red-500 mt-2" v-if="form.errors.product_ids">
                            Você precisa escolher um produto ou mais para processar
                        </div>
                    </div>
                    <div class="col-span-6 sm:col-span-6">
                        <label for="category_id" class="block mb-2 text-sm font-medium text-gray-900 ">Categoria</label>
            ...
            <div class="text-right p-6 space-x-2 border-t rounded-b">
                <button @click.prevent="emit('close')" type="button" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5">Cancelar</button>
